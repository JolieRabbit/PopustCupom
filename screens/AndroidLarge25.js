...
const AndroidLarge25 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.androidLarge25}>
      <Image
      ...
      />
      <Text style={[styles.sallve, styles.sallveTypo]}>{`
 Sallve`}</Text>
      <Image
        style={[styles.download32, styles.download32Position]}
        resizeMode="cover"
        source={require("../assets/download-3-2.png")}
      />
      <Image
        style={[styles.androidLarge25Child, styles.androidPosition]}
        resizeMode="cover"
      ...
      />
      <View style={[styles.androidLarge25Item, styles.androidPosition]} />
      <View style={[styles.vectorParent, styles.download32Position]}>
        <Image
        ...
        />
        <Text style={[styles.lojasAmericanas, styles.sallveTypo]}> Sallve</Text>
        <View style={[styles.instanceChild2, styles.instanceChildPosition]} />
        <Text style={[styles.felizpascoa, styles.sallveTypo]}> ACIDOS</Text>
        <Pressable
        ...
        <Text style={[styles.copiar, styles.sallveTypo]}>COPIAR</Text>
