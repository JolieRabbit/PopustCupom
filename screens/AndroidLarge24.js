...
const AndroidLarge24 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.androidLarge24}>
      <Image
        style={[styles.androidLarge24Child, styles.rectangleViewPosition]}
        resizeMode="cover"
        source={require("../assets/rectangle-1.png")}
      />
      <Text style={[styles.sallve, styles.sallveTypo]}> Sallve</Text>
      <Pressable
        style={[styles.rectangleParent, styles.rectangleLayout]}
        onPress={() => navigation.navigate("AndroidLarge25")}
      >
      ...
      <Text style={[styles.descontoEmCidos, styles.sallveTypo]}>
        20% desconto em ácidos
      </Text>
