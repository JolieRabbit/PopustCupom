...
const AndroidLarge23 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.androidLarge23}>
      <Image
      ...
      />
      <Text style={[styles.principia, styles.copiarTypo]}>{`
Principia`}</Text>
      <Image
        style={styles.download42}
        resizeMode="cover"
        source={require("../assets/download-4-2.png")}
      />
      <Image
        style={[styles.androidLarge23Child, styles.androidPosition]}
        resizeMode="cover"
      ...
      />
      <View style={[styles.androidLarge23Item, styles.androidPosition]} />
