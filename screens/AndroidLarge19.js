...
const AndroidLarge19 = () => {
  ...
  return (
    <View style={styles.androidLarge19}>
      ...
      />
      <Text style={[styles.pocaCosmeticos, styles.copiarTypo]}>{`Época
Cosmeticos`}</Text>
      <Image
        style={[styles.androidLarge19Child, styles.androidPosition]}
        resizeMode="cover"
      ...
      />
      <View style={[styles.androidLarge19Item, styles.androidPosition]} />
      <View style={styles.vectorParent}>
        ...
        />
        <Text style={[styles.lojasAmericanas, styles.copiarTypo]}>{`Época
Cosmeticos`}</Text>
        <View style={[styles.instanceChild2, styles.instanceChildPosition]} />
        <Text style={[styles.felizpascoa, styles.copiarTypo]}> VITAMINAC</Text>
        <Pressable
      ...
      <Image
        style={styles.icon2}
        resizeMode="cover"
        source={require("../assets/100935-1.png")}
      />
    </View>
  );
};
